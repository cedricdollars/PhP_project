			...
			<form method="POST" action="?page=<?php echo $page_name; ?>">
				...
				<div class="inner-form">
					...
					<div class="form-group label-floating">
						...
						<p class="help-block">Représente le nom du fournisseur</p>
					</div>

					<div class="form-group label-floating">
						<label>Adresse</label>
						<textarea class="form-control" placeholder="Adresse" rows="3" id="textArea" name="adresse"><?php echo isset($_POST['adresse']) ? $_POST['adresse'] : ''; ?></textarea>
						<p class="help-block">Représente l'adresse du fournisseur</p>
					</div>
				</div>
				<br><br>
